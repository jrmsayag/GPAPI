...
public final class EmptyDigitsList extends AbstractNode {
	...
	@Override
	public final EmptyDigitsList mutatedCopy(GeneticOperatorInterface geneticOperator){
		return copy();
	}
	
	
	@Override
	public final EmptyDigitsList copy() {
		return new EmptyDigitsList();
	}
	@Override
