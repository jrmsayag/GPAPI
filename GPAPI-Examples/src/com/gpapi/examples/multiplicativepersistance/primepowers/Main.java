	...
	public static void main(String[] args) throws InvocationTargetException, InterruptedException, ExecutionException, IOException {
		...
		GlobalFitnessAlgorithm algorithm = GlobalFitnessAlgorithmBuilder.create(
					...
					EvolvedIndividualBuilder.create(geneticOperator)
						.setInitRpbsSize(10)
						.setRpbsTypes(Arrays.asList(RealValue.create(), RealValue.create(), RealValue.create(), RealValue.create()))
						.setRpbsArgsTypes(Arrays.asList(Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList()))
						.setRpbsArgsNames(Arrays.asList(Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList()))
						.setInitAdfsSize(10)
		...
		DataManager.saveIndividual(bestGeneration.getBestIndividualFor(bestGeneration.getBestPopulation()), "multiplicativepersistance/best_primepowers.ser");
	}
}
