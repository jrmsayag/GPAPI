...
public final class VertexNode extends AbstractNode {

	private static final long serialVersionUID = 1390304798854113458L;
	...
	@Override
	public final Vertex getReturnType() {
		return vertex;
	}
	...
	public VertexNode(Vertex vertex){
		if(vertex == null)
			throw new NullPointerException("A vertex must be specified!");
		else
			this.vertex = vertex;
	}
	...
	@Override
	public final VertexNode copy() {
		return new VertexNode(vertex.copy());
	}
