 ...
 *
 * ---------------
 * AbstractAchitecturalCrossoverOperator.java
 * ---------------
 * (C) Copyright 2015-2016, by Jeremy Sayag and Contributors.
 *
...
public abstract class AbstractAchitecturalCrossoverOperator extends AbstractCrossoverOperator {
	
	private static final long serialVersionUID = -2404774052424764750L;
	
	private final ArchitectureAlterationSchemeInterface architectureAlterationScheme;
	public final ArchitectureAlterationSchemeInterface getArchitectureAlterationScheme() {
		return architectureAlterationScheme;
	}
	
	public AbstractAchitecturalCrossoverOperator(
		...
		super(
				...
				globalExternalNodes, 
				globalInternalNodes);
		this.architectureAlterationScheme = architectureAlterationScheme.copy();
	}
}
