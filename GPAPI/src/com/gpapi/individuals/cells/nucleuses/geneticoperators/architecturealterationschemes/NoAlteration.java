...
public final class NoAlteration implements ArchitectureAlterationSchemeInterface {

	private static final long serialVersionUID = -555790706366886990L;
	...
	@Override
	public final NoAlteration copy() {
		return new NoAlteration();
	}
}
