...
public final class Sin extends AbstractNode {
	
	private static final long serialVersionUID = 4233463825084085590L;
	...
	public final Result execute() throws Exception {
		...
		arg.setValue(Math.sin(arg.getValue()));
