...
public final class Not extends AbstractNode {
	
	private static final long serialVersionUID = 3832552863368788917L;
	
	private static final String name = "!";

	private static final BooleanValue returnType = BooleanValue.create();
	
	private static final List<AbstractType> argsTypes = Collections.unmodifiableList(Arrays.asList(BooleanValue.create()));
	...
	public final Result execute() throws Exception {
		...
		BooleanValue arg = (BooleanValue) result.getValue();
