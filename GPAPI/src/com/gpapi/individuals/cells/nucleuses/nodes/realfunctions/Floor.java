...
public final class Floor extends AbstractNode {
	
	private static final long serialVersionUID = 7626132421781530648L;
	...
	public final Result execute() throws Exception {
		...
		arg.setValue(Math.floor(arg.getValue()));
