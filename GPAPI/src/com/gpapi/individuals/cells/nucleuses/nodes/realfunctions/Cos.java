...
public final class Cos extends AbstractNode {
	
	private static final long serialVersionUID = 7321076843944389367L;
	...
	public final Result execute() throws Exception {
		...
		arg.setValue(Math.cos(arg.getValue()));
