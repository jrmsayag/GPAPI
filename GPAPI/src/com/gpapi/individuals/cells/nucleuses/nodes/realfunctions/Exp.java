...
public final class Exp extends AbstractNode {
	
	private static final long serialVersionUID = -6479351219108267665L;
	...
	public final Result execute() throws Exception {
		...
		arg.setValue(Math.exp(arg.getValue()));
